...
#define IS_REQ_READ_BODY_COMPLETE(x) \
	((x & REQ_STATE_READ_BODY_COMPLETE) == REQ_STATE_READ_BODY_COMPLETE)
#define IS_REQ_READ_COMPLETE(x) ((x & REQ_STATE_READ_COMPLETE) == REQ_STATE_READ_COMPLETE)
#define IS_REQ_PROCESS_IN_COMPLETE(x) \
	((x & REQ_STATE_PROCESS_IN_COMPLETE) == REQ_STATE_PROCESS_IN_COMPLETE)
#define IS_REQ_PROCESS_OUT_COMPLETE(x) \
	((x & REQ_STATE_PROCESS_OUT_COMPLETE) == REQ_STATE_PROCESS_OUT_COMPLETE)
...
typedef struct RequestContext_s {
	...
	RequestContext_s(const Server &server) : server(server) {}
